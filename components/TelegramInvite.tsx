    ...
    <div className="space-y-8 max-w-2xl mx-auto text-gray-800">
      ...
      <div className="p-6 bg-green-50 rounded-xl border border-green-200 shadow-sm space-y-4">
        ...
        <a
          ...
          className="group inline-flex items-center gap-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 focus:ring-4 focus:ring-emerald-300 outline-none font-semibold text-lg"
        >
        ...
        <p className="text-gray-700">📝 Copy and paste the following template when you join:</p>
