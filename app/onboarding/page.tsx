...
export default function OnboardingPage() {
    ...
    const [activeTab, setActiveTab] = useState<string>(
        searchParams.get('showRules') ? 'rules' : 'welcome',
    );
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-6">
                                    <div className="prose max-w-none">
                                        ...
                                        <p>
                                            In this interactive game, you will navigate through a
                                            series of checkpoints, each testing your knowledge of
                                            our community guidelines. Successfully complete the
                                            challenges to earn your place in our volunteer team!
                                        </p>

                                        <h3>Why This Matters</h3>
                                        <p>
                                            Understanding our community rules and culture is
                                            essential for effective collaboration. This gamified
                                            experience makes learning engaging while ensuring you
                                            are well-prepared to contribute to our community.
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-amber-50 p-6 rounded-lg border border-amber-200 hover:scale-103 transition-transform duration-300 cursor-pointer">
                                        <h3 className="font-medium text-amber-800 text-lg mb-3">
                                            Before You Begin:
                                        </h3>
                                        <ul className="space-y-2 text-amber-700">
                                            <li className="flex items-start">
                                                ...
                                                <span>
                                                    Review the Community Rules tab to familiarize
                                                    yourself with our guidelines
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <ArrowRight className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>
                                                    Prepare to answer questions about these rules
                                                    during the game
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <ArrowRight className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>
                                                    You will need to score 100% to receive the
                                                    Telegram group link
                                                </span>
                                            </li>
                                        </ul>
                                ...
                                <CardFooter className="flex justify-between">
                                    <Button
                                        variant="outline"
                                        className="bg-[#77c042] text-white hover:bg-[#77c045] hover:text-white"
                                        asChild
                                    >
                                        <Link href="/">
                                    ...
                                    <Button
                                        className="text-white cursor-pointer bg-neutral-800"
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-2xl">
                                        IT Community Rules & Guidelines
                                    </CardTitle>
                                    <CardDescription>
                                        Please familiarize yourself with these rules before joining
                                ...
                                <CardFooter className="flex justify-between">
                                    <Button
                                        variant="outline"
                                        className=" cursor-pointer bg-[#77c042] text-white hover:bg-[#77c045] hover:text-white"
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <h2>
                                                <strong>
                                                    Please use your own name, not a nickname!
                                                </strong>
                                            </h2>
                                        </label>
                                        <Input
                                    ...
                                    <div className="bg-green-50 p-6 rounded-lg border border-green-200 hover:scale-103 transition-transform duration-300 cursor-pointer">
                                        ...
                                        <ul className="space-y-2 text-green-700">
                                            ...
                                            <li className="flex items-start">
                                                <ArrowRight className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>
                                                    Answer questions about community rules at each
                                                    checkpoint
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <ArrowRight className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>
                                                    Complete all checkpoints and score 100% to
                                                    succeed
                                                </span>
                                            </li>
                                        </ul>
                                ...
                                <CardFooter className="flex flex-col sm:flex-row gap-3 sm:justify-between">
                                    <Button
                                        variant="outline"
                                        onClick={() => setActiveTab('rules')}
                                        className="w-full sm:w-auto cursor-pointer bg-[#77c042] text-white hover:bg-[#77c042] hover:text-white"
                                    >
