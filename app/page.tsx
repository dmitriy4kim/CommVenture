            ...
            <main className="flex-1">
                        ...
                        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                            <div className="space-y-4">
                                ...
                                <p className="text-xl text-gray-600 max-w-[600px]">
                                    ...
                                    starts here. Learn, explore, and join our vibrant community.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                                    <Link href="/onboarding">
                                        <Button
                                            size="lg"
                                            className="w-full sm:w-auto cursor-pointer bg-[#77c042] hover:bg-[#77c042]"
                                        >
                                            Start Your Journey{' '}
                                    ...
                                    <Link href="/onboarding?showRules=true">
                                        <Button
                                            size="lg"
                                            variant="outline"
                                            className="w-full sm:w-auto cursor-pointer  text-[#77c042] hover:text-[#77c042]"
                                        >
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="text-center mb-12">
                            ...
                            <p className="mt-4 text-xl text-white max-w-[700px] mx-auto">
                                ...
                                volunteering with the IT Community of Uzbekistan
                            </p>
                        </div>
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="bg-neutral-800 rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <p className="text-gray-400">
                                    Understand the community guidelines and expectations through an
                            ...
                            <div className="bg-neutral-800 rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <p className="text-gray-400">
                                    Navigate through interactive checkpoints and answer questions to
                                    test your knowledge
                                </p>
                            </div>
                            ...
                            <div className="bg-neutral-800 rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <p className="text-gray-400">
                                    Successfully complete the journey to receive access to our
                ...
                <section className="py-16 bg-[#77c042]">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl  tracking-tighter sm:text-4xl md:text-5xl text-white font-bold">
                                What benefits you can get from the IT community?
                            </h2>
                            <p className="mt-4 text-xl text-white max-w-[700px] mx-auto">
                                The IT Community is a space where tech enthusiasts grow, connect,
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="bg-[#77c042] rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <p className="text-white">
                                    Always helping and learning from each other.
                                </p>
                            </div>
                            ...
                            <div className="bg-[#77c042] rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <h3 className="text-xl text-white font-bold mb-2 ">
                                    🚀 Real projects you can join and contribute to
                                </h3>
                                <p className="text-white">
                                    Working on hands-on, real-world tech projects.
                                </p>
                            </div>
                            ...
                            <div className="bg-[#77c042] rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <h3 className="text-xl text-white font-bold mb-2 ">
                                    🏢 Demo Days – visits to top tech companies and their campuses
                                </h3>
                                <p className="text-white">
                                    Exploring leading tech companies and their work culture.
                                </p>
                            </div>
                            ...
                            <div className="bg-[#77c042] rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <h3 className="text-xl text-white font-bold mb-2 ">
                                    🎯 Access to exclusive internships and job offers
                                </h3>
                                <p className="text-white">
                                    Get direct access to amazing internship and job opportunities.
                                </p>
                            </div>
                            ...
                            <div className="bg-[#77c042] rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <h3 className="text-xl text-white font-bold mb-2 ]">
                                    🎁 Merch & certificates for active volunteers
                                </h3>
                                <p className="text-white">
                                    Earn cool swag and certificates for your contributions.
                                </p>
                            </div>
                            ...
                            <div className="bg-[#77c042] rounded-xl p-6 shadow-sm border border-[#77c042] flex flex-col items-center text-center hover:cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <h3 className="text-xl text-white font-bold mb-2 ">
                                    🗓 Weekly meetups with other motivated members
                                </h3>
                                <p className="text-white">
                                    Join weekly meetups to share ideas and grow together.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-2">
                            <div className="bg-neutral-800 rounded-xl p-6 shadow-sm border border-[#77c042] cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <p className="text-white">
                                    &quot;Joining the IT Community as a volunteer has been one of
                                    the best decisions of my career. I have met amazing people and
                                    learned so much!&quot;
                                </p>
                            </div>
                            ...
                            <div className="bg-neutral-800 rounded-xl p-6 shadow-sm border border-[#77c042] cursor-pointer hover:scale-103 transition-transform duration-300">
                                ...
                                <p className="text-white">
                                    &quot;The community has opened so many doors for me
                                    professionally. The networking opportunities are
                                    incredible!&quot;
                                </p>
                            </div>
                        </div>
                ...
                <section className="py-16 bg-[#77c042] text-white">
                    <div className="container mx-auto px-4 md:px-6 text-center">
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-4">
                            Explore the Official IT Community of Uzbekistan
                        </h2>
                        <p className="text-xl max-w-[700px] mx-auto mb-8 text-green-50">
                            Discover opportunities, resources, and connect with IT professionals
                            across Uzbekistan on the official platform.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <a href="https://itcom.uz/" target="_blank" rel="noopener noreferrer">
                                <Button
                                    size="lg"
                                    variant="secondary"
            ...
            <footer className="bg-neutral-800 text-white py-12">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-400">
                                ...
                                <li>
                                    <Link
                                        href="/onboarding?showRules=true"
                                        className="hover:text-white transition-colors"
                                    >
                                        Community Rules
                                    </Link>
                    ...
                    <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
                        <p>
                            © {new Date().getFullYear()} IT Community of Uzbekistan. All rights
                            reserved.
                        </p>
                    </div>
                </div>
